...
func testRunParentFolder(t *T) {
	...
	gomod := exec.Command("go", "mod", "edit", "-replace", "github.com/2637309949/micro/v3=github.com/2637309949/micro/v3@v3.0.0")
...
func testRunNewWithGit(t *T) {
	...
	if _, err := f.WriteString("\nreplace github.com/2637309949/micro/v3 => github.com/2637309949/micro/v3 master"); err != nil {
		t.Fatal(string(outp))
		return
	}
