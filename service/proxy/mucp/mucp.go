...
import (
	...
	grpcc "github.com/2637309949/micro/v3/service/client/grpc"
	...
	"github.com/2637309949/micro/v3/service/router/registry"
...
func (p *Proxy) getLink(r router.Route) (client.Client, error) {
	...
	l, ok := p.Links[r.Link]
	if !ok {
		return nil, errors.InternalServerError("link not found")
	}
	return l, nil
}
...
func (p *Proxy) ServeRequest(ctx context.Context, req server.Request, rsp server.Response) error {
	...
	if len(service) == 0 {
		return errors.BadRequest("service name is blank")
	}
	...
	if len(routes) == 0 {
		return errors.InternalServerError("route not found")
	}
