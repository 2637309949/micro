...
In go-micro, modules such as config could only be accessed via the service object, for example `srv.Options().Config.Read()`. In Micro this has been made easier by providing public functions in each package which can be accessed by importing any package, nested within "github.com/2637309949/micro/v3/service". Here is an example of how you can load config in Micro:
...
* [Auth](https://github.com/2637309949/micro/tree/master/service/auth)
* [Broker](https://github.com/2637309949/micro/tree/master/service/broker)  
* [Client](https://github.com/2637309949/micro/tree/master/service/client)
* [Config](https://github.com/2637309949/micro/tree/master/service/config)
* [Context](https://github.com/2637309949/micro/tree/master/service/context)
* [Errors](https://github.com/2637309949/micro/tree/master/service/errors)
* [Logger](https://github.com/2637309949/micro/tree/master/service/logger)
* [Store](https://github.com/2637309949/micro/tree/master/service/store)
