...
import (
	...
	prox "github.com/2637309949/micro/v3/service/proxy"
	"github.com/2637309949/micro/v3/service/proxy/grpc"
	"github.com/2637309949/micro/v3/service/proxy/http"
	"github.com/2637309949/micro/v3/service/proxy/mucp"
	rt "github.com/2637309949/micro/v3/service/runtime"
	"github.com/2637309949/micro/v3/service/server"
	ccli "github.com/urfave/cli/v2"

	// services
	api "github.com/2637309949/micro/v3/service/api/server"
	auth "github.com/2637309949/micro/v3/service/auth/server"
	broker "github.com/2637309949/micro/v3/service/broker/server"
	config "github.com/2637309949/micro/v3/service/config/server"
	events "github.com/2637309949/micro/v3/service/events/server"
	network "github.com/2637309949/micro/v3/service/network/server"
	proxy "github.com/2637309949/micro/v3/service/proxy/server"
	registry "github.com/2637309949/micro/v3/service/registry/server"
	runtime "github.com/2637309949/micro/v3/service/runtime/server"
	store "github.com/2637309949/micro/v3/service/store/server"
	"github.com/2637309949/micro/v3/service/web"

	// misc commands
	"github.com/2637309949/micro/v3/cmd/service/handler/exec"
	"github.com/2637309949/micro/v3/cmd/service/handler/file"
)
